...
#预编译标记定义
LOCAL_CFLAGS := -DUTIL_EXPORT -DLINUX -DUSE_FILE32API -D_FILE_OFFSET_BITS=64 -Wno-multichar -D_ANDROID -DLIBDIR=\"\" -DBUILDING_LIBICONV -DIN_LIBRARY
#导出预编译标记定义
LOCAL_EXPORT_CFLAGS := -DLINUX
